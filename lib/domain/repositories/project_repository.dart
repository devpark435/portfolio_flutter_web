...
''',
          ...
          troubleshooting: [
            ...
            Troubleshooting(
                issue: '짧은 개발 기간 내 다국어 지원 구현',
                context: '해커톤 시간 제약 속에서 다양한 국가 정보와 문화적 정확성을 보장해야 하는 어려움 직면',
                solution:
                    '효율적인 국제화(i18n) 아키텍처 설계 및 자동화된 번역 파이프라인 구축. 문화적 요소 검증을 위한 테스트 프로세스 간소화',
                learning: '제한된 시간 내 효과적인 프로젝트 범위 관리와 우선순위 설정의 중요성 체득')
          ],
          improvements: [
            '다국어 지원',
            '콘텐츠 다양화',
